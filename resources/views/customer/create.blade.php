            ...
            <div class="card">
                ...
                <div class="card-body">
                    @if ($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form action="{{ route('customer.store') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="about" id="" cols="30" rows="5">{{ old('about') }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
